...
public final class HoverEvent {
	 ...
	 * @throws IllegalArgumentException      if is a legacy component and already
	 *                                       has a content
	 * @throws UnsupportedOperationException if content action does not match hover
	 *                                       event action
	 */
	...
	public enum Action {
		...
		/**
		 * Removed since 1.12. Advancements instead simply use show_text. The ID of an
		 * achievement or statistic to display. Example: new ComponentText(
	...
	/**
	 * Gets the appropriate {@link Content} class for an {@link Action} for the GSON
	 * serialization
	 *
